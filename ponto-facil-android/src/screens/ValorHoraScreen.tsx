...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 16, fontFamily: theme.fonts.medium, color: theme.colors.secondary, marginTop: 4 },
  ...
  cardTitle: { color: theme.colors.on_surface, fontSize: 18, fontFamily: theme.fonts.bold },
